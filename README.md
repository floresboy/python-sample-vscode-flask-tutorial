[![Build Status](https://dev.azure.com/kstraatman0263/kstraatman/_apis/build/status/floresboy.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/kstraatman0263/kstraatman/_build/latest?definitionId=1&branchName=master)
